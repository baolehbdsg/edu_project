...
package com.hebin.core.bean;

import com.hebin.core.utils.SQLFilter;
...
//        params.put(Constant.PAGE, page);
    ...
    //设置一定条件的查询
    public IPage<T> getPage(QueryCondition params, String defaultOrderField, boolean isAsc,String userid) {
        //分页参数
        long curPage = 1;
        long limit = 10;
